...
/**
 * HeroProfessional Component
 * Clean, professional hero section with name, position, and portfolio label
...
export function HeroProfessional({
  ...
  contact,
  className,
  accentColor = "#22d3ee", // cyan-400 default
}: HeroProfessionalProps) {
  return (
    <div
      className={cn(
        "relative w-full min-h-[60vh] flex items-center justify-center px-6 py-20",
        className
      )}
    >
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <motion.p
          ...
          className="text-xl md:text-2xl lg:text-3xl text-white/70 font-light mb-8"
        >
          {title}
        </motion.p>
